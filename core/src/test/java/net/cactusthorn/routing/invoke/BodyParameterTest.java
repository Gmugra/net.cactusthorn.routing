...
public class BodyParameterTest extends InvokeTestAncestor {
    ...
    public static final MediaType TEST_DATE = new MediaType("test", "date");
    ...
    public void exception() {
        ...
        assertThrows(RoutingInitializationException.class, () -> new BodyParameter(m, p, HOLDER, mediaTypes("aa", "bb")));
    }
    ...
    public void ok() throws Exception {
        ...
        holder.register(TEST_DATE, TEST_CONSUMER);
        Method m = findMethod(EntryPoint1.class, "context");
        Parameter p = m.getParameters()[0];
        BodyParameter body = new BodyParameter(m, p, holder, mediaTypes("test", "date"));
